...
export const projects = [
  {
    ...
    gallery: [
      'assets/projects/smartmall/home.png',
      'assets/projects/smartmall/products.png',
      'assets/projects/smartmall/detail.png',
      'assets/projects/smartmall/cart.png',
      'assets/projects/smartmall/login.png',
      'assets/projects/smartmall/checkout.png',
      'assets/projects/smartmall/profile.png'
    ],
    demoVideo: 'assets/projects/smartmall/demo.mp4',
    tags: ['Vue2', 'Vuex', 'Vant', '移动端', '电商'],
    techStack: ['Vue2', 'Vuex', 'Vue Router', 'Vant UI', 'Axios'],
    highlights: [
      '实现了完整的电商购物流程',
      '使用Vuex进行状态管理',
      '响应式设计适配移动端',
    ...
    githubUrl: 'https://github.com/xingyuanshenshuang/hm-shopping',
    demoUrl: '',
  ...
  },
  {
    ...
    gallery: [
      'assets/projects/eventmgmt/login.png',
      'assets/projects/eventmgmt/articles.png',
      'assets/projects/eventmgmt/categories.png'
    ],
...
export const featuredProjects = [
  ...
  },
  {
    id: 'aiworks',
    name: 'AI作品集',
    description: '使用Midjourney、Stable Diffusion等AI工具创作的艺术作品。',
